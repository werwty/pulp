# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-31 13:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('url', models.TextField(blank=True, validators=[django.core.validators.URLValidator])),
                ('artifact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pulp_app.Artifact')),
            ],
        ),
        migrations.CreateModel(
            name='Importer',
        ...
        migrations.AddField(
            ...
            name='importer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pulp_app.Importer'),
        ),
        migrations.AddField(
            model_name='deferredartifact',
            name='importer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pulp_app.Importer'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='downloadcatalog',
            unique_together=set([('artifact', 'importer')]),
        ),
        migrations.AlterUniqueTogether(
            name='deferredartifact',
